...
export const dynamicRoutes = [
  ...
  {
    path: '/carManage/series/:seriesId',
    hidden: true,
    permissions: ['car:series:list'],
  ...
  {
    path: '/carManage/sales/statistics/screen',
    hidden: true,
    permissions: ['car:sales:statistics'],
    component: () => import('@/views/car/statistics/screen'),
