<template>
  <div class="app-container">
    ...
    <el-table :loading="loading" :data="seriesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="品牌名称" align="center" :show-overflow-tooltip="true" v-if="columns[2].visible"
                       prop="brandName"/>
      ...
      <el-table-column label="车系ID" align="center" :show-overflow-tooltip="true" v-if="columns[5].visible"
                       prop="seriesId"/>
      <el-table-column label="经销商报价" align="center" :show-overflow-tooltip="true" v-if="columns[6].visible"
                       prop="dealerPriceStr"/>
      <el-table-column label="官方指导价" align="center" :show-overflow-tooltip="true" v-if="columns[7].visible"
                       prop="officialPriceStr"/>
      ...
      <el-table-column label="最低价格" align="center" :show-overflow-tooltip="true" v-if="columns[9].visible"
                       prop="minPrice"/>
      <el-table-column label="月总销量" align="center" :show-overflow-tooltip="true" v-if="columns[10].visible"
                       prop="monthTotalSales"/>
      <el-table-column label="城市总销量" align="center" :show-overflow-tooltip="true" v-if="columns[11].visible"
                       prop="cityTotalSales"/>
      ...
      <el-table-column label="上市时间" align="center" v-if="columns[14].visible" prop="marketTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.marketTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="综合" align="center" :show-overflow-tooltip="true" v-if="columns[15].visible"
                       prop="overallScore"/>
      <el-table-column label="外观" align="center" :show-overflow-tooltip="true" v-if="columns[16].visible"
                       prop="exteriorScore"/>
      <el-table-column label="内饰" align="center" :show-overflow-tooltip="true" v-if="columns[17].visible"
                       prop="interiorScore"/>
      <el-table-column label="空间" align="center" :show-overflow-tooltip="true" v-if="columns[18].visible"
                       prop="spaceScore"/>
      <el-table-column label="操控" align="center" :show-overflow-tooltip="true" v-if="columns[19].visible"
                       prop="handlingScore"/>
      <el-table-column label="舒适性" align="center" :show-overflow-tooltip="true" v-if="columns[20].visible"
                       prop="comfortScore"/>
      <el-table-column label="动力" align="center" :show-overflow-tooltip="true" v-if="columns[21].visible"
                       prop="powerScore"/>
      <el-table-column label="配置" align="center" :show-overflow-tooltip="true" v-if="columns[22].visible"
                       prop="configurationScore"/>
      <el-table-column label="创建时间" align="center" :show-overflow-tooltip="true" v-if="columns[23].visible"
                       prop="createTime"/>
      <el-table-column label="创建人" align="center" :show-overflow-tooltip="true" v-if="columns[24].visible"
                       prop="createBy"/>
      <el-table-column label="更新时间" align="center" :show-overflow-tooltip="true" v-if="columns[25].visible"
                       prop="updateTime"/>
      <el-table-column label="备注" align="center" :show-overflow-tooltip="true" v-if="columns[26].visible"
                       prop="remark"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="月总销量" prop="monthTotalSales">
          <el-input-number :min="0" style="width: 100%" v-model="form.monthTotalSales" placeholder="请输入月总销量"/>
        </el-form-item>
        <el-form-item label="城市总销量" prop="cityTotalSales">
          <el-input-number :min="0" style="width: 100%" v-model="form.cityTotalSales" placeholder="请输入城市总销量"/>
        </el-form-item>
        <el-form-item label="车型" prop="modelType">
        ...
        <el-form-item label="综合" prop="overallScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.overallScore"
                           placeholder="请输入综合"/>
        </el-form-item>
        <el-form-item label="外观" prop="exteriorScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.exteriorScore"
                           placeholder="请输入外观"/>
        </el-form-item>
        <el-form-item label="内饰" prop="interiorScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.interiorScore"
                           placeholder="请输入内饰"/>
        </el-form-item>
        <el-form-item label="空间" prop="spaceScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.spaceScore"
                           placeholder="请输入空间"/>
        </el-form-item>
        <el-form-item label="操控" prop="handlingScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.handlingScore"
                           placeholder="请输入操控"/>
        </el-form-item>
        <el-form-item label="舒适性" prop="comfortScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.comfortScore"
                           placeholder="请输入舒适性"/>
        </el-form-item>
        <el-form-item label="动力" prop="powerScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.powerScore"
                           placeholder="请输入动力"/>
        </el-form-item>
        <el-form-item label="配置" prop="configurationScore">
          <el-input-number :min="0" :max="5" :precision="2" style="width: 100%" v-model="form.configurationScore"
                           placeholder="请输入配置"/>
        </el-form-item>
...
import {addSeries, delSeries, getSeries, listSeries, updateSeries} from "@/api/car/series";
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {key: 8, label: '最大价格', visible: false},
        {key: 9, label: '最低价格', visible: false},
